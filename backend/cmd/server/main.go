...
func main() {
	...
	api.Post("/targets/:id/hunter/sessions/:sid/pause", handlers.PauseHuntSession)
	api.Post("/targets/:id/hunter/sessions/:sid/resume", handlers.ResumeHuntSession)
	api.Delete("/targets/:id/hunter/sessions/:sid", handlers.CancelHuntSession)
